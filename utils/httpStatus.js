...
const NOT_FOUND = { code: 404, data: null, message: '资源不存在' }
...
module.exports = { ERROR, SUCCESS, PASSWORD_ERROR, USER_NOT_EXIST, UNAUTHORIZED, FORBIDDEN, BAD_REQUEST, NOT_FOUND }
